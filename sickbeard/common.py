...
class Quality:
    ...
    ULTRAHDWEBDL = 1 << 9  # 512
    ULTRAHDBLURAY = 1 << 10  # 1024
    ...
    qualityStrings = {NONE: "N/A",
                      ...
                      ULTRAHDWEBDL: "2160p WEB-DL",
                      ULTRAHDBLURAY: "2160p BluRay"}
    ...
    def nameQuality(name):
        ...
        if checkName(["(pdtv|hdtv|dsr|tvrip).(xvid|x264)"], all) and not checkName(["(720|1080|2160)[pi]"], all) and not checkName(["hr.ws.pdtv.x264"], any):
            return Quality.SDTV
        elif checkName(["web.dl|webrip|web", "xvid|x264|h.?264"], all) and not checkName(["(720|1080|2160)[pi]"], all):
            return Quality.SDTV
        ...
        elif checkName(["720p", "hdtv"], all) or checkName(["hr.ws.pdtv.x264"], any) and not checkName(["(1080|2160)[pi]"], all):
            return Quality.HDTV
        ...
        elif checkName(["2160p", "bluray|hddvd", "x264|x265"], all):
            return Quality.ULTRAHDBLURAY
        else:
...
HD = Quality.combineQualities([Quality.HDTV, Quality.FULLHDTV, Quality.HDWEBDL, Quality.FULLHDWEBDL, Quality.HDBLURAY, Quality.FULLHDBLURAY, Quality.ULTRAHDWEBDL, Quality.ULTRAHDBLURAY], [])  # HD720p + HD1080p + HD2160p
